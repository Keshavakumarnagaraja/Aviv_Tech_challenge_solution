...
_sql_alchemy_listing_price_log_repository = adapters.SqlAlchemyListingPriceLogRepository(_db_session)
...
persist_listing_price_log_use_case = use_cases.PersistListingPriceLog(_sql_alchemy_listing_price_log_repository)
retrieve_listings_price_log_by_listing_id_use_case = use_cases.RetrieveListingsPriceLogByListingId(_sql_alchemy_listing_price_log_repository)